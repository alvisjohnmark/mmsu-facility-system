        ...
        <div class="reservation-form">
            <form @submit.prevent="submitReservation">
                ...
                <div v-show="currentStep === 1">
                    ...
                    <table
                        class="shadow-md bg-white rounded-lg overflow-hidden border border-gray-300"
                    >
                        <tr>
                            <td>Facility Name:</td>
                            <td>
                    ...
                    <p class="mt-4 text-sm text-gray-600">
                        <strong>Disclaimer:</strong> For events spanning
                        multiple days, the program schedule should maintain
                        consistent timing throughout the duration.
                    </p>
                    ...
                    <div class="mt-2">
                        ...
                        <button
                            @click.prevent="validateConflict"
                ...
                <div v-show="currentStep === 2">
                    <h2 class="font-bold text-lg mb-4">
                        Do you want to avail any of the Services?
                    </h2>
                    <h5>(Click Yes to avail)</h5>
                    <br />
                    <table
                        class="shadow-md bg-white rounded-lg overflow-hidden"
                    >
                        <thead>
                            <tr>
                                <th>Services</th>
                            ...
                            >
                                ...
                                <td>
                                    <input
                                        ...
                                        value="Yes"
                                        v-model="serviceSelection[index]"
                                        @change="toggleFields(index, 'Yes')"
                                    />
                                </td>
                                <td>
                                    <input
                                        ...
                                        value="No"
                                        v-model="serviceSelection[index]"
                                        @change="toggleFields(index, 'No')"
                                    />
                                </td>
                                <td
                                    v-if="
                                        serviceSelection[index] === 'Yes' &&
                ...
                <div v-show="currentStep === 3">
                    ...
                    >
                        ...
                        <tr>
                            <td>
                                <label for="affiliated">MMSU Affiliated:</label>
                            </td>
                            <td colspan="2">
                                <div style="display: flex; align-items: center">
                                    ...
                                    <input
                                        ...
                                        id="affiliatedYes"
                                        value="Yes"
                                        v-model="contactInfo.mmsu_affiliated"
                                        @change="handleAffiliatedChange"
                                    />
                                    <label
                                        for="affiliatedNo"
                        ...
                        <tr v-if="contactInfo.mmsu_affiliated === 'Yes'">
                            <td>
                                <label for="university_id"
                                    >University ID (Student Number or Employee
                                    Number):
                                </label>
                            </td>
                            <td>
                        ...
                        <tr v-if="contactInfo.mmsu_affiliated === 'Yes'">
                            <td>
                                <label for="department"
                                    >Office or Department Name:</label
                                >
                            </td>
                            <td>
                                <input
                        ...
                        <tr v-if="contactInfo.mmsu_affiliated === 'No'">
                            <td>
                                <label for="officeAgency">Office/Agency:</label>
                            </td>
                            <td>
                                <input
                                    type="text"
                                    id="officeAgency"
                                    v-model="contactInfo.officeAgency"
                                />
                            </td>
                        </tr>
                    </table>
                ...
                <div v-show="currentStep === 4">
                    ...
                    <ul>
                        <li
                            ...
                            ) in getSelectedServices()"
                            :key="index"
                        >
                            {{ selectedService.service_name }} -
                            <b>Quantity:</b> {{ selectedService.quantity }} |
                            <b>Remarks:</b>
                            {{ selectedService.additionalRequest }}
                        </li>
                    </ul>
                    ...
                    <h2 class="font-bold text-lg mb-4">Contact Information</h2>
                    <p>
                        Name: {{ contactInfo.fname }} {{ contactInfo.mname }}
                        {{ contactInfo.lname }}
                    </p>
                    ...
                    <!-- Facility -->
                    <p>
                        Facility Price for Current Month:
                        {{ currentMonthFacilityPrice }}
                    </p>
                    ...
                    <ul>
                        ...
                        >
                            ...
                            <b>Quantity:</b> {{ selectedService.quantity }} |
                            <b>Total Price:</b>
                            {{ selectedService.total_price }}
                        </li>
                    </ul>
                    <br />
                    <p>
                        <b>Total Cost of Services Availed:</b>
                        {{ totalCostOfServices }}
                    </p>
                    <!-- Disclaimer -->

                    <p class="mt-4 text-sm text-gray-600">
                        <strong>Disclaimer:</strong> Prices may vary. This
                        represents the facility price and total cost of services
                        obtained. The final total will be included in the
                        emailed form.
                    </p>
                    ...
                    <div>
                        <p>
                            By completing this form, I acknowledge that I have
                            read and agree to the Data Privacy and Security
                            Policy and privacy practices of Mariano Marcos State
                            University (MMSU), including the potential transfer
                            of my personal information to MMSU affiliates and
                            third-party service providers for the purposes
...
export default {
    ...
    data() {
        return {
            // Assign the facilityId received as a prop
            currentStep: 1,
