<template lang="">
    <div class="flex flex-row w-full" style="overflow: auto">
        <!--Main-->
        ...
        <div
            class="bg-gray-100 shadow-xl min-h-screen w-full"
            style="font-family: Advantage"
        >
            <!--Content-->
            <div class="grid grid-cols-1 flex-row border-b-4 border-yellow-400">
                <!--Sub Nav-->
                <div
            ...
            <div class="mt-6 flex justify-evenly flex-row h-36">
                <!--Main Box-->

                <div
                    class="shadow lg border-r-4 border-yellow-400 basis-1/4 rounded-lg text-center"
                    style="background-color: #0c4b05"
                >
                    <!--Box 1-->
                    <span
                        class="flex items-center text-white text-lg font-normal mt-2"
                    >
                        <lord-icon
                            src="https://cdn.lordicon.com/omiqopzf.json"
                            trigger="hover"
                    ...
                    <div class="mt-5">
                        <span
                            id="countReservations"
                            class="font-bold text-4xl text-white"
                            >{{ admin.reservationCount }}</span
                        >
                    </div>
                </div>
                <!--Box 1 End-->
...
onMounted(() => {
    ...
    const countElementReservations =
        document.getElementById("countReservations");
