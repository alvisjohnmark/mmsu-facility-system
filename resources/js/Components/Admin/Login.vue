<template>
    <div class="background bg-gray-100">
        <div class="flex justify-center items-center h-screen">
            <div
                class="bg-white shadow-md shadow-gray-500 rounded-xl p-8 mt-2"
                style="
                    width: 516px;
                    height: 670px;
                ...
                <form @submit.prevent="login.login">
                    <div class="mb-4" style="margin-top: 3rem">
                        <input
                            ...
                            class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-green-800 focus:border-green-800"
                    ...
                    <div v-if="login.error" class="notification">
                    ...
                    <div class="flex justify-center mt-20">
                        <button
                            type="submit"
                            class="w-56 h-10 rounded-xl hover bg-green-800 text-white text-lg px-4 py-2 shadow-md lift-hover flex items-center justify-center"
                        >
                            Login
                        </button>
                    </div>
