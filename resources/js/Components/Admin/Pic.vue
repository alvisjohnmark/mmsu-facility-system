    ...
    <div class="flex flex-row w-full">
        ...
        >
            ...
            >
                <!--Sub Nav-->
                <div
                    class="shadow-md h-20 flex justify-between items-center"
                    style="background-color: #0c4b05"
                >
                    <span
                        class="flex items-center text-white ml-5 text-xl font-semibold"
                ...
                <div class="p-8">
                    ...
                    <div class="mb-6">
                        ...
                        >
                            <label
                                for="uploadInput"
                                class="upload-btn text-xl bg-blue-500 text-white px-4 py-2 rounded-md cursor-pointer transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:duration-300"
                            >
                                Select Image
                                <input
                                    type="file"
                            ...
                            <button
                                type="submit"
                                class="bg-white text-xl hover:bg-green-700 text-gray-800 hover:text-white font-semibold border-gray-600 border-2 px-4 py-2 ml-4 rounded-md cursor-pointer transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:duration-300"
                            >
                                SAVE
                            </button>
                            <!-- <router-link
                    ...
                    <div class="result-table">
                        <table class="w-full">
                            <thead>
                                <tr>
                                    <th class="text-left text-xl">Image</th>
                                    <th class="text-left text-xl">Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr
                                ...
                                >
                                    ...
                                    <td class="py-4">
                                        <button
                                            ...
                                            class="bg-red-500 text-white px-4 py-2 rounded-md cursor-pointer transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:duration-300"
                                        >
                                            Delete
                                        </button>
                                    </td>
